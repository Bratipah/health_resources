      ...
      child: Scaffold(
        ...
        body: BlocBuilder<ArticleBloc, ArticleState>(builder: (context, state) {
          ...
          if (state is ArticleLoadedState) {
            List<ArticleModel> data = state.articles;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                ...
                                // "to China and Turkey. In contrast, production in the United States in the first ten months of 2022 reached record levels and was 12% higher than the 2017-2021"
